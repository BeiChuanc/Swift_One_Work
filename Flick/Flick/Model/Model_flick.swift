...
/// 商店模型
class StoreModel_Flick: NSObject {
    
    /// ID编号
    var id_Flick: Int?
    
    /// 商品ID
    var goodsId_Flick: String?
    
    /// 商品名字
    var goodsName_Flick: String?
    
    /// 商品价格
    var goodsPrice_Flick: String?
    
    /// 是否顶部商品
    var goodIsTop_Flick: Bool?
    
    /// 是否特殊商品
    var goodIsSpecial_Flick: Bool?
    
    /// 是否VIP商品
    var goodIsVIP_Flick: Bool?
    
    init(id_Flick: Int? = nil,
         goodsId_Flick: String? = nil,
         goodsName_Flick: String? = nil,
         goodsPrice_Flick: String? = nil,
         goodIsTop_Flick: Bool? = false,
         goodIsLimit_Flick: Bool? = false,
         goodIsVIP_Flick: Bool? = false) {
        self.id_Flick = id_Flick
        self.goodsId_Flick = goodsId_Flick
        self.goodsName_Flick = goodsName_Flick
        self.goodsPrice_Flick = goodsPrice_Flick
        self.goodIsTop_Flick = goodIsTop_Flick
        self.goodIsSpecial_Flick = goodIsLimit_Flick
        self.goodIsVIP_Flick = goodIsVIP_Flick
        super.init()
    }
}
