...
class ProtocolViewController_Base_one: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 配置导航栏外观（白色背景 + 深色文字）
        let appearance_Base_one = UINavigationBarAppearance()
        appearance_Base_one.configureWithOpaqueBackground()
        appearance_Base_one.backgroundColor = .white
        appearance_Base_one.shadowColor = .clear
        appearance_Base_one.titleTextAttributes = [
            .foregroundColor: UIColor(red: 0.18, green: 0.22, blue: 0.28, alpha: 1),
            .font: UIFont.systemFont(ofSize: 16, weight: .semibold)
        ]
        navigationController?.navigationBar.standardAppearance   = appearance_Base_one
        navigationController?.navigationBar.scrollEdgeAppearance = appearance_Base_one
    ...
    private func setupUI_Base_one() {
        ...
        // 返回按钮（系统箭头 + 文字）
        let backBtn_Base_one = UIBarButtonItem(
        ...
        navigationItem.leftBarButtonItem = backBtn_Base_one
