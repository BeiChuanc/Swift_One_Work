...
class GiftPage_Base_one: UIViewController {
    ...
    private func buildComp1_Base_one() {
        ...
        card_Base_one.backgroundColor = .white
        ...
        priceLabel_Base_one.textColor = UIColor(hexstring_Base_one: "#111111")
        ...
        subLabel_Base_one.textColor = UIColor(hexstring_Base_one: "#111111")
    ...
    private func refreshSelectionUI_Base_one(selectedId: String?) {
        let selColor_Base_one = UIColor(hexstring_Base_one: "#A678F1").withAlphaComponent(0.25)

        /// 组件1
        let isComp1_Base_one = selectedId == topGift_Base_one?.goodsId_Base_one
        UIView.animate(withDuration: 0.18) {
            self.comp1Card_Base_one?.backgroundColor = isComp1_Base_one ? selColor_Base_one : .white
        }
        ...
        comp2Items_Base_one.forEach { item_Base_one in
            ...
            UIView.animate(withDuration: 0.18) {
                item_Base_one.backgroundColor = isSel_Base_one ? selColor_Base_one : .white
            }
        }
    }
}
