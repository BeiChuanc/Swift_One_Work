...
private struct DataSource_Glasspaint {
    ...
    /// 彩绘属性配置 (难度, 风格, 场景, 载体, 复刻率)
    static let paintingAttributes_Glasspaint: [(PaintingLevel_Glasspaint, PaintingStyle_Glasspaint, String, CarrierType_Glasspaint, Int)] = [
        (.beginner_glasspaint, .modern_glasspaint, "Home Decoration", .glassCup_glasspaint, 85),
        (.beginner_glasspaint, .cute_glasspaint, "Festival Gift", .glassPlate_glasspaint, 90),
        (.intermediate_glasspaint, .minimalist_glasspaint, "Art Collection", .ornament_glasspaint, 75),
        (.intermediate_glasspaint, .retro_glasspaint, "Home Decoration", .vase_glasspaint, 70),
        (.beginner_glasspaint, .modern_glasspaint, "Festival Gift", .glassCup_glasspaint, 88),
        (.advanced_glasspaint, .artistic_glasspaint, "Art Collection", .window_glasspaint, 60),
        (.intermediate_glasspaint, .cute_glasspaint, "Home Decoration", .glassCup_glasspaint, 80),
        (.beginner_glasspaint, .minimalist_glasspaint, "Festival Gift", .glassPlate_glasspaint, 92),
        (.advanced_glasspaint, .retro_glasspaint, "Art Collection", .vase_glasspaint, 65),
        (.intermediate_glasspaint, .modern_glasspaint, "Home Decoration", .ornament_glasspaint, 78),
    ]
    ...
    static let userPaintingPreferences_Glasspaint: [(PaintingLevel_Glasspaint, [PaintingStyle_Glasspaint], [String])] = [
        (.beginner_glasspaint, [.modern_glasspaint, .cute_glasspaint], ["Home Decoration", "Festival Gift"]),
        (.intermediate_glasspaint, [.minimalist_glasspaint, .retro_glasspaint], ["Art Collection", "Home Decoration"]),
        (.beginner_glasspaint, [.cute_glasspaint, .modern_glasspaint], ["Festival Gift"]),
        (.advanced_glasspaint, [.artistic_glasspaint, .retro_glasspaint], ["Art Collection"]),
        (.intermediate_glasspaint, [.modern_glasspaint, .minimalist_glasspaint], ["Home Decoration", "Festival Gift"]),
    ]
...
class DataGenerator_Glasspaint {
    ...
    /// 为帖子分配彩绘属性
    /// 功能：为所有帖子添加难度、风格、场景、载体、复刻率、日期等属性
    func assignPaintingAttributes_Glasspaint() {
        ...
        for i_glasspaint in 0..<dataLocal_glasspaint.titleList_Glasspaint.count {
            ...
            let (level_glasspaint, style_glasspaint, scene_glasspaint, carrier_glasspaint, replication_glasspaint) = 
            ...
            dataLocal_glasspaint.titleList_Glasspaint[i_glasspaint].replicationRate_Glasspaint = replication_glasspaint
