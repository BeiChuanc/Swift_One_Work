...
class Store_Tidy: NSObject {
    ...
    var goodsList_Tidy: [StoreModel_Tidy] = [
        ...
        StoreModel_Tidy(
            id_Tidy: 1,
            goodsId_Tidy: "praise.one.3_9",
            goodsName_Tidy: "x1",
            goodsPrice_Tidy: "$3.99",
            goodIsTop_Tidy: true
        ),
        StoreModel_Tidy(
            id_Tidy: 2,
            goodsId_Tidy: "praise.one.9_9",
            goodsName_Tidy: "x5",
        ...
        StoreModel_Tidy(
            id_Tidy: 8,
            goodsId_Tidy: "praise.gift.x1.5_9",
            goodsName_Tidy: "x1",
            goodsPrice_Tidy: "$5.99",
        ),
        StoreModel_Tidy(
            id_Tidy: 9,
        ...
        StoreModel_Tidy(
            id_Tidy: 10,
            goodsId_Tidy: "praise.gift.x10.39_9",
            goodsName_Tidy: "x10",
            goodsPrice_Tidy: "$39.99",
        ),
        StoreModel_Tidy(
            id_Tidy: 11,
            goodsId_Tidy: "praise.gift.x30.59_9",
            goodsName_Tidy: "x30",
            goodsPrice_Tidy: "$59.99",
        ),
        ...
        StoreModel_Tidy(
            id_Tidy: 12,
            goodsId_Tidy: "praise.subscribe.1w.9_9",
        ...
        StoreModel_Tidy(
            id_Tidy: 13,
            goodsId_Tidy: "praise.subscribe.1m.24_9",
            goodsName_Tidy: "Premium (1m.)",
            goodsPrice_Tidy: "$24.99",
            goodIsVIP_Tidy: true
        ),
        StoreModel_Tidy(
            id_Tidy: 14,
            goodsId_Tidy: "praise.subscribe.3m.49_9",
        ...
        StoreModel_Tidy(
            id_Tidy: 15,
            goodsId_Tidy: "praise.subscribe.1y.69_9",
