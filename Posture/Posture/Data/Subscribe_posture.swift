...
class Subscribe_Posture: NSObject {
    ...
    var goodsList_Posture: [StoreModel_Posture] = [
        StoreModel_Posture(
            id_Posture: 1,
            goodsId_Posture: "posture.gift.4_9",
        ...
        StoreModel_Posture(
            id_Posture: 2,
            goodsId_Posture: "posture.gift.x1.4_9",
            goodsName_Posture: "x1",
            goodsPrice_Posture: "$4.99",
        ),
        StoreModel_Posture(
            id_Posture: 3,
            goodsId_Posture: "posture.gift.x5.14_9",
            goodsName_Posture: "x5",
            goodsPrice_Posture: "$14.99",
        ),
        StoreModel_Posture(
            id_Posture: 4,
            goodsId_Posture: "posture.gift.x10.19_9",
            goodsName_Posture: "x10",
            goodsPrice_Posture: "$19.99",
        ),
        StoreModel_Posture(
            id_Posture: 5,
            goodsId_Posture: "posture.gift.x30.49_9",
            goodsName_Posture: "x30",
            goodsPrice_Posture: "$49.99",
        ),
        StoreModel_Posture(
            id_Posture: 6,
            goodsId_Posture: "posture.gift.x1.6_9",
            goodsName_Posture: "x1",
            goodsPrice_Posture: "$6.99",
        ),
        StoreModel_Posture(
            id_Posture: 7,
            goodsId_Posture: "posture.gift.x5.19_9",
            goodsName_Posture: "x5",
            goodsPrice_Posture: "$19.99",
        ),
        StoreModel_Posture(
            id_Posture: 8,
            goodsId_Posture: "posture.gift.x10.29_9",
            goodsName_Posture: "x10",
            goodsPrice_Posture: "$29.99",
        ),
        StoreModel_Posture(
            id_Posture: 9,
            goodsId_Posture: "posture.gift.x30.79_9",
            goodsName_Posture: "x30",
        ...
        StoreModel_Posture(
            id_Posture: 9,
            goodsId_Posture: "posture.sub.1w.9_9",
        ...
        StoreModel_Posture(
            id_Posture: 10,
            goodsId_Posture: "posture.sub.1m.19_9",
        ...
        StoreModel_Posture(
            id_Posture: 11,
            goodsId_Posture: "posture.sub.3m.29_9",
        ...
        StoreModel_Posture(
            id_Posture: 12,
            goodsId_Posture: "posture.sub.1y.69_9",
        ...
        RMStore.default().requestProducts(products) { success, invalidProductIdentifiers in
            RMStore.default().addPayment(gid_Posture) { SKPaymentTransaction in
                ...
                if SKPaymentTransaction?.transactionState == .purchased {
                    ...
                    if (gid_Posture.contains("posture.gift.x5.3_9")) {
