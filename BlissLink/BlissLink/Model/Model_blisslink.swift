...
/// 预览用户数据模型
class PrewUserModel_blisslink: NSObject, Codable {
    
    /// 用户ID
    var userId_blisslink: Int?
    
    /// 用户名字
    var userName_blisslink: String?
    
    /// 用户简介
    var userIntroduce_blisslink: String?
    
    /// 用户头像
    var userHead_blisslink: String?
    
    /// 用户媒体
    var userMedia_blisslink: [String]?
    
    /// 用户喜欢帖子列表
    var userLike_blisslink: [TitleModel_blisslink] = []
    
    /// 用户关注数
    var userFollow_blisslink: Int?
    
    /// 用户粉丝数
    var userFans_blisslink: Int?
    ...
    /// 自定义初始化方法
    init(userId_blisslink: Int? = nil,
         userName_blisslink: String? = nil,
         userIntroduce_blisslink: String? = nil,
         userHead_blisslink: String? = nil,
         userMedia_blisslink: [String]? = nil,
         userLike_blisslink: [TitleModel_blisslink] = [],
         userFollow_blisslink: Int? = nil,
         userFans_blisslink: Int? = nil,
         yogaMatBackground_blisslink: YogaMatBackground_blisslink? = nil) {
        self.userId_blisslink = userId_blisslink
        self.userName_blisslink = userName_blisslink
        self.userIntroduce_blisslink = userIntroduce_blisslink
        self.userHead_blisslink = userHead_blisslink
        self.userMedia_blisslink = userMedia_blisslink
        self.userLike_blisslink = userLike_blisslink
        self.userFollow_blisslink = userFollow_blisslink
        self.userFans_blisslink = userFans_blisslink
...
/// 帖子数据模型
class TitleModel_blisslink: NSObject, Codable, Identifiable {
    
    /// 帖子唯一标识符，用于 Identifiable 协议
    var id: Int { titleId_blisslink }
    
    /// 帖子ID
    var titleId_blisslink: Int
    
    /// 拥有者ID
    var titleUserId_blisslink: Int
    
    /// 拥有者昵称
    var titleUserName_blisslink: String
    
    /// 帖子媒体资源数组
    var titleMeidas_blisslink: [String]
    
    /// 帖子标题
    var title_blisslink: String
    
    /// 帖子内容
    var titleContent_blisslink: String
    
    /// 帖子评论列表
    var reviews_blisslink: [Comment_blisslink]
    
    /// 喜欢个数
    var likes_blisslink: Int
    
    /// 帖子类型（扩展字段）
    var postType_blisslink: PostType_blisslink?
    
    /// 初始化方法
    init(titleId_blisslink: Int,
         titleUserId_blisslink: Int,
         titleUserName_blisslink: String,
         titleMeidas_blisslink: [String],
         title_blisslink: String,
         titleContent_blisslink: String,
         reviews_blisslink: [Comment_blisslink],
         likes_blisslink: Int,
         postType_blisslink: PostType_blisslink? = nil) {
        self.titleId_blisslink = titleId_blisslink
        self.titleUserId_blisslink = titleUserId_blisslink
        self.titleUserName_blisslink = titleUserName_blisslink
        self.titleMeidas_blisslink = titleMeidas_blisslink
        self.title_blisslink = title_blisslink
        self.titleContent_blisslink = titleContent_blisslink
        self.reviews_blisslink = reviews_blisslink
        self.likes_blisslink = likes_blisslink
...
/// 登录用户数据模型
class LoginUserModel_blisslink: NSObject, Codable, Identifiable {
    
    /// 用户唯一标识符，用于 Identifiable 协议
    var id: Int? { userId_blisslink }
    
    /// 用户ID
    var userId_blisslink: Int?
    
    /// 用户密码
    var userPwd_blisslink: String?
    ...
    /// 用户发布帖子列表
    var userPosts_blisslink: [TitleModel_blisslink]
    
    /// 用户喜欢帖子列表
    var userLike_blisslink: [TitleModel_blisslink]
    
    /// 用户关注列表
    var userFollow_blisslink: [PrewUserModel_blisslink]
    ...
    /// 初始化方法
    init(userId_blisslink: Int? = nil,
         userPwd_blisslink: String? = nil,
         userName_blisslink: String? = nil,
         userHead_blisslink: String? = nil,
         userIntroduce_blisslink: String? = nil,
         userPosts_blisslink: [TitleModel_blisslink],
         userLike_blisslink: [TitleModel_blisslink],
         userFollow_blisslink: [PrewUserModel_blisslink],
        ...
        self.userId_blisslink = userId_blisslink
        self.userPwd_blisslink = userPwd_blisslink
        self.userName_blisslink = userName_blisslink
        self.userHead_blisslink = userHead_blisslink
        self.userIntroduce_blisslink = userIntroduce_blisslink
        self.userPosts_blisslink = userPosts_blisslink
        self.userLike_blisslink = userLike_blisslink
        self.userFollow_blisslink = userFollow_blisslink
        self.yogaMatBackground_blisslink = yogaMatBackground_blisslink
...
/// 消息数据模型
class MessageModel_blisslink: Codable, Identifiable {
    
    /// 消息唯一标识符，用于 Identifiable 协议
    var id: Int? { messageId_blisslink }
    
    /// 消息ID
    var messageId_blisslink: Int?
    
    /// 消息内容
    var content_blisslink: String?
    
    /// 用户头像
    var userHead_blisslink: String?
    
    /// 是否是我发送的
    var isMine_blisslink: Bool?
    
    /// 消息时间
    var time_blisslink: String?
    
    /// 初始化方法
    init(messageId_blisslink: Int? = nil,
         content_blisslink: String? = nil,
         userHead_blisslink: String? = nil,
         isMine_blisslink: Bool? = nil,
         time_blisslink: String? = nil) {
        self.messageId_blisslink = messageId_blisslink
        self.content_blisslink = content_blisslink
        self.userHead_blisslink = userHead_blisslink
        self.isMine_blisslink = isMine_blisslink
        self.time_blisslink = time_blisslink
    }
}

/// 评论数据模型
class Comment_blisslink: NSObject, Codable, Identifiable {
    
    /// 评论唯一标识符，用于 Identifiable 协议
    var id: Int { commentId_blisslink }
    
    /// 评论ID
    var commentId_blisslink: Int
    
    /// 评论用户ID
    var commentUserId_blisslink: Int
    
    /// 评论用户昵称
    var commentUserName_blisslink: String
    
    /// 评论内容
    var commentContent_blisslink: String
    
    /// 初始化方法
    init(commentId_blisslink: Int,
         commentUserId_blisslink: Int,
         commentUserName_blisslink: String,
         commentContent_blisslink: String) {
        self.commentId_blisslink = commentId_blisslink
        self.commentUserId_blisslink = commentUserId_blisslink
        self.commentUserName_blisslink = commentUserName_blisslink
        self.commentContent_blisslink = commentContent_blisslink
        super.init()
    }
}
...
/// 商店模型
class StoreModel_blisslink: NSObject {
    
    /// ID编号
    var id_blisslink: Int?
    
    /// 商品ID
    var goodsId_blisslink: String?
    
    /// 商品名字
    var goodsName_blisslink: String?
    
    /// 商品价格
    var goodsPrice_blisslink: String?
    
    /// 是否顶部商品
    var goodIsTop_blisslink: Bool?
    
    /// 是否特殊商品
    var goodIsSpecial_blisslink: Bool?
    
    init(id_blisslink: Int? = nil,
         goodsId_blisslink: String? = nil,
         goodsName_blisslink: String? = nil,
         goodsPrice_blisslink: String? = nil,
         goodIsTop_blisslink: Bool? = false,
         goodIsLimit_blisslink: Bool? = false) {
        self.id_blisslink = id_blisslink
        self.goodsId_blisslink = goodsId_blisslink
        self.goodsName_blisslink = goodsName_blisslink
        self.goodsPrice_blisslink = goodsPrice_blisslink
        self.goodIsTop_blisslink = goodIsTop_blisslink
        self.goodIsSpecial_blisslink = goodIsLimit_blisslink
        super.init()
    }
}
