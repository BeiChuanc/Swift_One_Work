...
struct Release_baseswift: View {
        ...
        ZStack {
            ...
            ZStack {
                ...
                Circle()
                    ...
                    .offset(x: -170.w_baseswiftui, y: -220.h_baseswiftui)
                    .blur(radius: 55)
    ...
    private func progressStep_blisslink(icon_blisslink: String, title_blisslink: String, isCompleted_blisslink: Bool) -> some View {
        VStack(spacing: 6.h_baseswiftui) {
            ...
            Text(title_blisslink)
                .font(.system(size: 11.sp_baseswiftui, weight: isCompleted_blisslink ? .semibold : .medium))
        ...
        VStack(alignment: .leading, spacing: 12.h_baseswiftui) {
            ...
            HStack(spacing: 12.w_baseswiftui) {
                Image(systemName: "sparkles")
                    .font(.system(size: 18.sp_baseswiftui))
                    .foregroundStyle(
                        LinearGradient(
                            gradient: Gradient(colors: [Color(hex: "667EEA"), Color(hex: "764BA2")]),
                            startPoint: .topLeading,
        ...
        VStack(alignment: .leading, spacing: 12.h_baseswiftui) {
            ...
            ZStack(alignment: .topLeading) {
                ...
                if contentText_blisslink.isEmpty {
                    VStack(alignment: .leading, spacing: 8.h_baseswiftui) {
                        HStack(spacing: 8.w_baseswiftui) {
                ...
                TextEditor(text: $contentText_blisslink)
                    ...
                    .frame(minHeight: 180.h_baseswiftui)
    ...
    private func handleClearContent_blisslink() {
        ...
        Utils_baseswiftui.showInfo_baseswiftui(
            message_baseswiftui: "Content cleared",
            delay_baseswiftui: 1.0
        )
    }
    ...
    private func handlePublish_blisslink() {
        ...
        guard isValid_blisslink else {
            Utils_baseswiftui.showWarning_baseswiftui(
                message_baseswiftui: "Please complete all fields.",
                delay_baseswiftui: 1.5
            )
            return
        }
        ...
        Task { @MainActor in
            ...
            // 调用ViewModel发布帖子
            titleVM_baseswiftui.releasePost_baseswiftui(
                title_baseswiftui: titleText_blisslink,
                content_baseswiftui: contentText_blisslink,
                media_baseswiftui: selectedMediaName_blisslink,
                type_baseswiftui: 0
            )
