        ...
        ZStack {
            ...
            ZStack {
                ...
                Circle()
                    ...
                    .offset(x: 160.w_baseswiftui, y: 380.h_baseswiftui)
                    .blur(radius: 55)
            }
            .ignoresSafeArea()
        ...
        VStack(spacing: 16.h_baseswiftui) {
            ...
            ZStack {
                ...
                Image(systemName: "sparkles")
                    .font(.system(size: 40.sp_baseswiftui, weight: .semibold))
                    .foregroundStyle(
                        LinearGradient(
        ...
        HStack(spacing: 8.w_baseswiftui) {
            ...
            ForEach(0..<3) { index_blisslink in
                Rectangle()
                    ...
                    .frame(height: 4.h_baseswiftui)
                    .cornerRadius(2.h_baseswiftui)
            }
    ...
    private func handleRegister_blisslink() {
        ...
        guard isValid_blisslink else {
            if username_blisslink.isEmpty || password_blisslink.isEmpty || confirmPassword_blisslink.isEmpty {
                ...
                Utils_baseswiftui.showWarning_baseswiftui(
                    message_baseswiftui: "Passwords do not match.",
                    delay_baseswiftui: 1.5
                )
            }
            return
